...
public class ChatBoxManager : MonoBehaviour
{
    ...
    void Update()
    {
           ...
           || Input.GetMouseButtonDown(1) || Input.GetMouseButtonDown(2)))
        {
            ...
            chatBoxInputs[indice].transform.Find("Text").GetComponent<Text>().text = chatBoxInputs[indice].text;
            character += 1;
            if (character >= maxCharacter) {
                chatBoxInputs[indice].transform.Find("Text").GetComponent<Text>().alignment = TextAnchor.MiddleRight;
            }
        }
        if (chatBoxInputs[indice].text != "")
        {
            if (Input.GetKeyDown(KeyCode.Return) && character >= playerNextMessage.Length)
            {
                ...
                chatBoxInputs[indice].transform.Find("Text").GetComponent<Text>().alignment = TextAnchor.MiddleLeft;
                ...
                Debug.Log("nextchat: " + nextChat);
                if (nextChat != "" && nextChat != null)
                {
